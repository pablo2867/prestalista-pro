...
export default function PrestatariosPage() {
  ...
  const [form, setForm] = useState({
    ...
    email: '',
    direccion: '',
    estado: 'activo' as Prestatario['estado'],
    notas: ''
  })
  ...
  // ESTA ES LA FUNCIÓN QUE SINCRONIZA - USA LA MISMA VARIABLE QUE CAPITAL
    ...
    <main className="p-6 bg-gray-50 min-h-screen">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
        ...
        <div className="flex gap-3 w-full sm:w-auto">
          ...
          {/* BOTÓN DE SINCRONIZACIÓN - ESTE ES EL QUE BUSCAS */}
          <button
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center p-4 z-40">
          <div className="bg-white rounded-xl shadow-lg w-full max-w-md p-6">
            <h2 className="text-lg font-semibold mb-4">
              {editingId ? 'Editar Prestatario' : 'Nuevo Prestatario'}
            </h2>
